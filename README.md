...
MVP локального веб-стенда для сравнения mock-результатов MinerU, PaddleOCR, Qwen3-VL и Qwen3-8B-text на комплектах конструкторской документации электронных плат.
...
- mock-адаптеры моделей без API-ключей и внешних вызовов;
...
- определение таблиц пока равно `0` и является местом для интеграции OCR/парсеров;
